package com.example.listWorkers.configuration;
...
/**
 * Настройки конвейерной обработки
 */
@Configuration
public class IntegrationConfig {
    ...
    public FileWritingMessageHandler messageHandler() {
        FileWritingMessageHandler handler =
                new FileWritingMessageHandler(new File("C:/Users/александр/Desktop/Java Spring/Домашнее задание/Homework 11/listWorkers/files"));
